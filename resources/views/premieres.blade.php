  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <!--Блок с фильмами-->
        <div id="users_premiers">
          <div class="list_premieres">
            <h3>27 апреля</h3>
            <div class="item_premieres">
              <img src="Бладшот.jpeg" alt="">
              <h3 class="name">Бладшот</h3>
              <p class="born">8.3</p>
              <p class="born">Фантастика</p>
              <p class="born">2020, США</p>
            </div>
            <div class="item_premieres">
              <img src="джентльмены.jpg" alt="">
              <h3 class="name">Джентльмены</h3>
              <p class="born">9.4</p>
              <p class="born">Комедия</p>
              <p class="born">2020, США</p>
            </div>
            <h3>26 апреля</h3>
            <div class="item_premieres">
